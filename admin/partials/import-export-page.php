...
<div class="wrap bricks-remote-template-options">
    ...
    <div id="main-ui" class="bricks-ui-container">
        <div class="bricks-feature-card" data-feature="import">
            <h2>Import</h2>
            <p>Import your Bricks Remote Template links via your .csv or .json file.</p>
            <button class="button button-primary show-sub-ui" data-target="import-ui">Run Import</button>
        </div>

        <div class="bricks-feature-card" data-feature="export">
            <h2>Export</h2>
            <p>Export your Bricks Remote Template links to a .csv or .json file.</p>
            <button class="button button-primary show-sub-ui" data-target="export-ui">Run Export</button>
        </div>

        <div class="bricks-feature-card" data-feature="google-sheet">
            <h2>Import via Google Sheet</h2>
            <p>Import your Bricks Remote Template links via Google Sheet.</p>
            <button class="button button-primary show-sub-ui" data-target="google-sheet-ui">Run Import Google Sheet</button>
        </div>

        <div class="bricks-feature-card" data-feature="delete">
            <h2>Delete All</h2>
            <p>Delete all your Bricks Remote Template links.</p>
            <button class="button button-primary show-sub-ui" data-target="delete-ui">Delete</button>
        </div>
    </div>
        ...
        <div class="import-options">
            ...
            <div class="import-option">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" name="import_json" class="button button-primary">Import .json</button>
                </form>
            </div>
        </div>

        <button class="button button-secondary return-to-main">Back to Main Menu</button>
    </div>
